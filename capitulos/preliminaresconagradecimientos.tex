...
\chapter*{Preámbulo}
\thispagestyle{empty}
La visión artificial se encuentra en constante evolución en parte motivada por los avances de la Inteligencia Artificial y la optimización basados en Deep Learning. 
...
Las razón principal que me ha llevado a la realización de este trabajo ha sido el uso de ambas tecnologías comentadas anteriormente, dado están cada vez más en auge además de la propia curiosidad sobre el aprendizaje y funcionamiento de estas.

Este trabajo tiene como finalidad el estudio de la visión artificial dentro de un marco dietético nutricional de la obesidad aprovechando las tecnologías para abordar este problema.
